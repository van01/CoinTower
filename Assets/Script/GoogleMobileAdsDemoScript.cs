...
public class GoogleMobileAdsDemoScript : MonoBehaviour
{
	...
	static private GoogleMobileAdsDemoScript m_instance = null;
	...
	public static GoogleMobileAdsDemoScript Instance 
	{
		get 
		{
			if (m_instance == null)
			{
				m_instance = GameObject.FindObjectOfType (typeof(GoogleMobileAdsDemoScript)) as GoogleMobileAdsDemoScript;
			}
